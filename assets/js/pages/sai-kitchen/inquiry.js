            ...
            columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        if (inquiryPermission >= 3) {
                            ...
                            var action = `
                            <a type="button" onclick="setInquiryId(` + full.inquiryId + `)" data-toggle="modal" data-target="#ScheduleDate" class="btn btn-sm btn-clean btn-icon" title="Re-Schedule">
						...
						`;
                            if (inquiryPermission == 4) {
                                action += '\
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Escalate">\
