    ...
    var _handleFormAcceptMeasurement = function() {
        ...
        FormValidation
            ...
            .on('core.form.valid', function() {
                ...
                $.ajax({
                    type: "Post",
                    url: baseURL + '/Design/ClientAcceptDesign',
    ...
    var _handleFormRejectMeasurement = function() {
        ...
        FormValidation
            ...
            .on('core.form.valid', function() {
                ...
                $.ajax({
                    type: "Post",
                    url: baseURL + '/Design/ClientRejectDesign',
...
files.forEach(element => {
    ...
    if(isImgLoaded==false){
        imgViewHTML +=`<div class="panellumviewimg" id="`+element.fileUrl+`" value= `+element.fileUrl+`></div>`;
        isImgLoaded=true;
        }
