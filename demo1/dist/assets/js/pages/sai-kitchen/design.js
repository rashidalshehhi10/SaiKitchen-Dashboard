        ...
        var table = $('#kt_datatable').DataTable({
            ...
            columnDefs: [{
                    ...
                    <i class="la la-ruler-combined"></i>
                            ...
                            ret += ` <a href="viewwardrobemeasurement.html?inquiryWorkscopeId=` + full.inquiryWorkscopeId + `"class="btn btn-sm btn-clean btn-icon" title="View Measurement">
                <i class="la la-ruler-combined"></i>
            </a>`;
                        }
                        if (full.questionaireType == 1) {
                            ret += ` <a href="addkitchendesign.html?inquiryWorkscopeId=` + full.inquiryWorkscopeId + `"class="btn btn-sm btn-clean btn-icon" title="Add Design">
                    <i class="la fab la-codepen"></i>
                </a>`;
                        } else {
                            ret += ` <a href="addwardrobedesign.html?inquiryWorkscopeId=` + full.inquiryWorkscopeId + `"class="btn btn-sm btn-clean btn-icon" title="Add Design">
                <i class="la fab la-codepen"></i>
            </a>`;
                        }
