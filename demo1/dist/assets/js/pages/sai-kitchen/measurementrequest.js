            ...
            columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (inquiryPermission >= 3) {
                            ...
                            var action=``; 
                    action += ` <a href="viewmeasurement.html?inquiryWorkscopeId=` + full.inquiryId + `"class="btn btn-sm btn-clean btn-icon"  style="background-color:#734f43;margin:2px" title="View Measurement">
...
jQuery(document).ready(function() {
    ...
    $('#kt_datatable').on('click', 'td.dtr-control', function () {
        ...
        $('#kt_datatable').DataTable().rows().every(function(){
