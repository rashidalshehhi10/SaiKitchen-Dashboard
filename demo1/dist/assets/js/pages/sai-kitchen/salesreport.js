    ...
    $.ajax({
        ...
        success: function(response) {
           ...
           for (let i = 0; i < response.data.customerSatisfaction.length; i++) {
            xdatachart.push( monthNames[parseInt(response.data.customerSatisfaction[i].month)+1]);
            ...
            for (let i = 0; i < response.data.monthlyAmountReceived.length; i++) {
                xdatachart.push( monthNames[parseInt(response.data.monthlyAmountReceived[i].month)+1]);
