            ...
            columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (inquiryPermission >= 3) {
                            ...
                            var action=``; 
                                                 action += ` <a href="viewdesigncustomer.html?inquiryWorkscopeId=` + full.inquiryId + `"class="btn btn-sm btn-clean btn-icon"  style="background-color:#734f43;margin:2px" title="View Design">
